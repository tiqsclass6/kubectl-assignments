...
resource "helm_release" "ebs_csi_driver" {
  depends_on = [aws_iam_role.ebs_csi_iam_role, aws_iam_openid_connect_provider.oidc_provider, aws_eks_cluster.demo,
  aws_eks_node_group.private-nodes, null_resource.update_kubeconfig]
